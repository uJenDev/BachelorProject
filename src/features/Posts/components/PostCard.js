...
const PostCard = ({ 
  ...
  return (
    <div className={`
        bg-gray-700 py-2 px-3 rounded-xl shadow-md duration-300 ease-out
        ${selectedPost?.id === post.id ? 'translate-x-5' : ''}
    `}>
        <div className='flex flex-col pb-2 space-y-1 '>
            ...
            >
                ...
                <p className='text-xs text-gray-400'>by {post.author.displayName}</p>
            </button>
